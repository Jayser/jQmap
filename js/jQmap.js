...
(function(){
	...
	var jQmap = {
		...
		Init: function () {
			...
			if( jQmap.memory.map !== '' ){
				...
				jQmap.$showcase.find('.jQmap').remove();
	...
	// START )) 
	jQmap.Init();
	window.jQmap = jQmap.Init;

}());
/*
	$(function(){
		$('.jQmap-showcase img').attr('src','img/ceneo_04.jpg');
		---or---
		$('.jQmap-showcase img').attr('src','img/ceneo_06.jpg');
		jQmap();
	});
*/